				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<select  class="form-control text-right" name="plan">
								 
										<?php 

										$query="SELECT * FROM `plans` order by plan";

										$result=$conn->query($query);

										while($row1=$result->fetch_array()){

										echo "<option value='" .$row1['planID']. "'>" . $row1['plan']. " Months</option>";
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_package" type="button" data-id="<?php echo $row['id'] ?>" data-package="<?php echo $row['package'] ?>" data-amount="<?php echo $row['amount'] ?>" >Edit</button>
