...
<div class="container-fluid">
	...
	<div class="col-lg-12">
		<div class="row">
			<!-- FORM Panel -->
			<div class="col-md-4">
			<form action="" id="manage-trainer" enctype="multipart/form-data">
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control text-right" name="achievment" required>
							</div>
							<div class="form-group">
								<label class="control-label">Description</label>
								<textarea class="form-control text-right" name="description" ></textarea>
							</div>
							<div class="form-group">
								<label class="control-label">Specialities</label>
								<textarea class="form-control text-right" name="speciality" required></textarea>
							</div>
							<div class="form-group">
								<label class="" ><b>Classes</b></label><br>
								From:<input type="time" class="form-control text-right" name="time_from" required><br>
								To:<input type="time" class="form-control text-right" name="time_to" required>
							</div>
							<div class="form-group">
								<label class="control-label">Picture</label>
								<input type="file" class="form-control text-right" name="img" required>
							</div>
					</div>
