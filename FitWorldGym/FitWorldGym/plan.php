...
<head>
	...
	<link href="./asset/css/style.css" rel="stylesheet" type="text/css" />
        ...
        <script src="./asset/js/ajax-handler.js" type="text/javascript"></script>
...
swal({
             ...
             text: "Wait for your registration approval.",
             type: "warning",
           // timer: 6000,
			...
			<div class="left">
				...
				<div class="contact">
					<form action="checkout.php" method="post">
						<h3>CHOOSE PLAN</h3>
						 <select class="input-custom input-custom--sm" name="plan" id="course-list" onChange="getSubjects(this.value);" required>
						  <option value="" disabled selected> - Select Duration -</option>
					  <?php
					     foreach($courseResult as $course){
						?>  
						  <option value="<?php echo $course["planID"]; ?>"><?php echo $course["plan"]; ?> Months</option>
					  <?php
					  }
					    ?>
					    </select>
						 ...
						 <select name="package" id="subject-list" class="input-custom input-custom--sm" required>
