			...
			<div class="left">
				...
				<div class="contact">
					<form action="resetpswd.php" method="post">
						...
						<button class="submit" name="reset">Submit</button>
					</form>
				</div>
			</div>
			<div class="right">
...
if(isset($_POST['reset'])){
	...
	try {
		...
		$mail->Subject = 'FitWorldGym - Reset Password';
		...
		$mail->Body = '<html>
				   ...
				   <body>
					  ...
					  <p><strong>To reset your password following this link:</strong> http://localhost/fitworldgym/forgetpswd.php?email='.$email.'</p>
		...
		echo "<script>window.alert('Check your email for reset password link')</script>";
